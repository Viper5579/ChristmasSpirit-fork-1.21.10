...
@OnlyIn(Dist.CLIENT)
public class LeatherReindeerArmorLayer extends LayerRenderer<EntityReindeer, ModelReindeer<EntityReindeer>> {

    private final ModelReindeer<EntityReindeer> field_215341_a = new ModelReindeer<>(0.1F);

    public LeatherReindeerArmorLayer(IEntityRenderer<EntityReindeer, ModelReindeer<EntityReindeer>> renderer) {
        super(renderer);
    }
