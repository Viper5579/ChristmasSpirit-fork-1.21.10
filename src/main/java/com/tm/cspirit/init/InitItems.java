...
public class InitItems {
    ...
    //INGREDIENTS
    public static final RegistryObject<Item> FLOUR =                       regItem("flour", () -> new ItemBase());
    public static final RegistryObject<Item> ICING =                       regItem("icing",() -> new ItemBase());

    public static final RegistryObject<Item> FOOD_DYE_RED =                regItem("food_dye_red", () -> new ItemBase());
    public static final RegistryObject<Item> FOOD_DYE_GREEN =              regItem("food_dye_green", () -> new ItemBase());
    public static final RegistryObject<Item> FOOD_DYE_BLUE =               regItem("food_dye_blue", () -> new ItemBase());

    public static final RegistryObject<Item> PEPPERMINT_LEAF =             regItem("peppermint_leaf", () -> new ItemBase());
    public static final RegistryObject<Item> PEPPERMINT_CANDY_MIX =        regItem("peppermint_candy_mix", () -> new ItemBase());

    public static final RegistryObject<Item> SUGAR_COOKIE_DOUGH =          regItem("sugar_cookie_dough", () -> new ItemBase());
    public static final RegistryObject<Item> SUGAR_COOKIE_SHEET =          regItem("sugar_cookie_sheet", () -> new ItemBase());
    public static final RegistryObject<Item> GINGER_GROUND =               regItem("ginger_ground", () -> new ItemBase());
    public static final RegistryObject<Item> GINGERBREAD_DOUGH =           regItem("gingerbread_dough", () -> new ItemBase());
    public static final RegistryObject<Item> GINGERBREAD_SHEET =           regItem("gingerbread_sheet", () -> new ItemBase());
